# TomOS Family — Documentation & Knowledge Architecture

## Overview

This document defines the canonical architecture for managing documentation, project knowledge, and AI context across the TomOS Family ecosystem.
...
### Primary Repo: `tomos-family-docs`
...
**ChatGPT/Other:**
- Provide raw URL: `https://raw.githubusercontent.com/braggy9/tomos-family-docs/main/projects/tomos-app/CLAUDE.md`
...
- [ ] Create `tomos-family-docs` repo on GitHub
...
**Note:** Individual repos may retain their own `CLAUDE.md` that references back to `tomos-family-docs` for shared resources. The central repo is the source of truth for shared design/architecture.
...
For full documentation, see: github.com/braggy9/tomos-family-docs/projects/tomos-app/
...
A: Central docs (`tomos-family-docs`) are authoritative. Update central first, then sync local references.

**Q: Can I use this with Claude Code's `--project` flag?**
A: Yes. Point Claude Code at the `tomos-family-docs` repo for documentation sessions, or at individual app repos for coding sessions (they'll reference central docs via MCP).
